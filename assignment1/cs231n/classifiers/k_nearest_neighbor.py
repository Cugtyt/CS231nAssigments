...
class KNearestNeighbor(object):
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in xrange(num_test):
      #######################################################################
      # TODO:                                                               #
      # Compute the l2 distance between the ith test point and all trainin0g #
  ...
  def compute_distances_no_loops(self, X):
    ...
    dists = X2 + X_train2 - 2 * X_X_train
    #  ############## Simple,but memory error  ###############
    # print(np.tile(X, (5000, 1, 1)).shape)
    # print(np.tile(X, (5000, 1, 1)).swapaxes(0, 1).shape)
    # X = np.tile(X, (5000, 1, 1)).swapaxes(0, 1)
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      # print(self.y_train[np.argsort(dists[i])].shape)
      # print(self.y_train[np.argsort(dists[i])][0:k].shape)
      # print(len(self.y_train[np.argsort(dists[i])][0:k].tolist()))
      closest_y.extend(self.y_train[np.argsort(dists[i])][0:k].tolist())
      # print(len(closest_y))
      #########################################################################
      # TODO:                                                                 #
